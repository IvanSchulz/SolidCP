...
[![Build](https://github.com/simonegli8/FuseCP/actions/workflows/deploy-release.yaml/badge.svg?branch=release)](https://github.com/simonegli8/FuseCP/actions/workflows/deploy-release.yaml)
[![Tests](https://github.com/simonegli8/FuseCP/actions/workflows/test-release.yaml/badge.svg?branch=release)](https://github.com/simonegli8/FuseCP/actions/workflows/test-release.yaml/badge.svg?branch=release)
...
Here are some [tutorials for FuseCP](https://www.youtube.com/playlist?list=PLViYFEOr_vWBMyf_Co7RXs9rDQQK4y5pj).

Here's a [programmer's introduction video to the FuseCP Linux port](https://youtu.be/RBxv2wvfMdw).
