FuseCP.LinuxVmConfig - Service for Linux and FreeBSD VM configuration (Hostname, IPs, root-password), uses KVP-Exchange.
...
2 - cd /{Your path}/FuseCP.LinuxVmConfig/FuseCP.LinuxVmConfig
3 - g++ -std=c++11 -pthread *.cpp -o FuseCP.LinuxVmConfig
