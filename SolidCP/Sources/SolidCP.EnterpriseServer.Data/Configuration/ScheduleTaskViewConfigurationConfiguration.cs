...
public partial class ScheduleTaskViewConfigurationConfiguration: EntityTypeConfiguration<ScheduleTaskViewConfiguration>
{
    public override void Configure() {
        ...
        HasData(() => new ScheduleTaskViewConfiguration[] {
            ...
            new ScheduleTaskViewConfiguration() { ConfigurationId = "ASP_NET", TaskId = "SCHEDULE_TASK_CHECK_WEBSITES_SSL", Description = "~/DesktopModules/FuseCP/ScheduleTaskControls/CheckWebsitesSslView.ascx", Environment = "ASP.NET" }
		});
        #endregion
