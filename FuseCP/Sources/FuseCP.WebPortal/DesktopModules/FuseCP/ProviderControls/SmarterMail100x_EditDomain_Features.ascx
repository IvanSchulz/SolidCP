<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail100x_EditDomain_Features.ascx.cs" Inherits="FuseCP.Portal.ProviderControls.SmarterMail100x_EditDomain_Features" %>
<table width="100%">
    <tr>
