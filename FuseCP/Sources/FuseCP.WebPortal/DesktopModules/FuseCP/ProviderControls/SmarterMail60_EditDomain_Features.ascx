<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail60_EditDomain_Features.ascx.cs" Inherits="FuseCP.Portal.ProviderControls.SmarterMail60_EditDomain_Features" %>
<table width="100%">
    <tr>
