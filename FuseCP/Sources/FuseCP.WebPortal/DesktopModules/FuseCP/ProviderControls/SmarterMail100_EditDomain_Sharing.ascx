<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail100_EditDomain_Sharing.ascx.cs" Inherits="FuseCP.Portal.ProviderControls.SmarterMail100_EditDomain_Sharing" %>
<table width="100%">
    <tr>
