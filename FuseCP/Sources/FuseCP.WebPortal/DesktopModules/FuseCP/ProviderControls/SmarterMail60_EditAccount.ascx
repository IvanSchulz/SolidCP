<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail60_EditAccount.ascx.cs" Inherits="FuseCP.Portal.ProviderControls.SmarterMail60_EditAccount" %>
