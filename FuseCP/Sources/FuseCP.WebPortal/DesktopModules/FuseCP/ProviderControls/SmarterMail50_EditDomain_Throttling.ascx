<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail50_EditDomain_Throttling.ascx.cs" Inherits="FuseCP.Portal.ProviderControls.SmarterMail50_EditDomain_Throttling" %>
<table>
    <tr>
