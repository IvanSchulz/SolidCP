<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail100_EditDomain_Throttling.ascx.cs" Inherits="FuseCP.Portal.ProviderControls.SmarterMail100_EditDomain_Throttling" %>
<table>
    <tr>
