<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail50_EditDomain_Sharing.ascx.cs" Inherits="FuseCP.Portal.ProviderControls.SmarterMail50_EditDomain_Sharing" %>
<table width="100%">
    <tr>
