...
<table  id="tblQuotas" runat="server" cellpadding="3">
    <tr ID="pnlDiskspace" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaDiskspace" runat="server" QuotaName="OS.Diskspace" DisplayGauge="True" />&nbsp;&nbsp;(<asp:HyperLink
    ...
    <tr ID="pnlBandwidth" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaBandwidth" runat="server" QuotaName="OS.Bandwidth" 
    ...
    <tr ID="pnlDomains" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaDomains" runat="server" QuotaName="OS.Domains" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlSubDomains" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaSubDomains" runat="server" QuotaName="OS.SubDomains" DisplayGauge="True" /></td>
    </tr>
...
<%--    <tr ID="pnlDomainPointers" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaDomainPointers" runat="server" QuotaName="OS.DomainPointers" DisplayGauge="True" /></td>
    </tr>--%>
    ...
    <tr ID="pnlOrganizations" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaOrganizations" runat="server" QuotaName="HostedSolution.Organizations" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlUserAccounts" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaUserAccounts" runat="server" QuotaName="HostedSolution.Users" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlDeletedUsers" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaDeletedUsers" runat="server" QuotaName="HostedSolution.DeletedUsers" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlExchangeAccounts" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaExchangeAccounts" runat="server" QuotaName="Exchange2007.Mailboxes" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlExchangeStorage" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaExchangeStorage" runat="server" QuotaName="Exchange2007.DiskSpace" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlMailAccounts" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaMailAccounts" runat="server" QuotaName="Mail.Accounts" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlOCSUsers" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaOCSUsers" runat="server" QuotaName="OCS.Users" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlLyncUsers" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaLyncUsers" runat="server" QuotaName="Lync.Users" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlLyncPhone" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaLyncPhone" runat="server" QuotaName="Lync.PhoneNumbers" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlSfBUsers" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaSfBUsers" runat="server" QuotaName="SfB.Users" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlSfBPhone" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaSfBPhone" runat="server" QuotaName="SfB.PhoneNumbers" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlBlackBerryUsers" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaBlackBerryUsers" runat="server" QuotaName="BlackBerry.Users" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlSharepointSites" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaSharepointSites" runat="server" QuotaName="HostedSharePoint.Sites" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlEnterpriseSharepointSites" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaEnterpriseSharepointSites" runat="server" QuotaName="HostedSharePointEnterprise.Sites" DisplayGauge="True" /></td>
    </tr>    
    <tr ID="pnlWebSites" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaWebSites" runat="server" QuotaName="Web.Sites" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlFtpAccounts" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaFtpAccounts" runat="server" QuotaName="FTP.Accounts" DisplayGauge="True"/></td>
    </tr>
    <tr ID="pnlMsSQL2008Databases" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotamssql2008databases" runat="server" QuotaName="MsSQL2008.Databases" DisplayGauge="True"/></td>
    </tr>
    <tr ID="pnlMsSQL2012Databases" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotamssql2012databases" runat="server" QuotaName="MsSQL2012.Databases" DisplayGauge="True"/></td>
    </tr>
    <tr ID="pnlMsSQL2014Databases" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotamssql2014databases" runat="server" QuotaName="MsSQL2014.Databases" DisplayGauge="True"/></td>
    </tr>
    <tr ID="pnlMsSQL2016Databases" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotamssql2016databases" runat="server" QuotaName="MsSQL2016.Databases" DisplayGauge="True"/></td>
    </tr>
    <tr ID="pnlMsSQL2017Databases" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotamssql2017databases" runat="server" QuotaName="MsSQL2017.Databases" DisplayGauge="True"/></td>
    </tr>
    <tr ID="pnlMsSQL2019Databases" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotamssql2019databases" runat="server" QuotaName="MsSQL2019.Databases" DisplayGauge="True"/></td>
    </tr>
    ...
    <tr ID="pnlMySQL8Databases" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotamysql8databases" runat="server" QuotaName="MySQL8.Databases" DisplayGauge="True"/></td>
    </tr>
    <tr ID="pnlMySQL9Databases" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotamysql9databases" runat="server" QuotaName="MySQL9.Databases" DisplayGauge="True"/></td>
    </tr>
    <tr ID="pnlMariaDBDatabases" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotamariadbdatabases" runat="server" QuotaName="MariaDB.Databases" DisplayGauge="True"/></td>
    </tr>
	<tr id="pnlHyperVForPC" runat="server">
		...
		<td class="Normal"><fcp:Quota ID="quotaNumberOfVm" runat="server" QuotaName="VPSForPC.ServersNumber" DisplayGauge="True" /></td>
	</tr>
    <tr id="pnlFolders" runat="server">
		...
		<td class="Normal"><fcp:Quota ID="quotaNumberOfFolders" runat="server" QuotaName="EnterpriseStorage.Folders" DisplayGauge="True" /></td>
	</tr>
    <tr id="pnlEnterpriseStorage" runat="server">
		...
		<td class="Normal"><fcp:Quota ID="quotaEnterpriseStorage" runat="server" QuotaName="EnterpriseStorage.DiskStorageSpace" DisplayGauge="True" /></td>
	</tr>
    <tr ID="pnlRdsCollections" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaRdsCollections" runat="server" QuotaName="RDS.Collections" DisplayGauge="True" /></td>
    </tr> 
    <tr ID="pnlRdsServers" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaRdsServers" runat="server" QuotaName="RDS.Servers" DisplayGauge="True" /></td>
    </tr> 
    <tr ID="pnlRdsUsers" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotaRdsUsers" runat="server" QuotaName="RDS.Users" DisplayGauge="True" /></td>
    </tr>
     <tr ID="pnlVPS2012Servers" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotavps2012servers" runat="server" QuotaName="VPS2012.ServersNumber" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlVPS2012CpuQuota" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotavps2012cpuquota" runat="server" QuotaName="VPS2012.CpuNumber" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlVPS2012RamQuota" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotavps2012ramquota" runat="server" QuotaName="VPS2012.Ram" DisplayGauge="True" /></td>
    </tr>
    <tr ID="pnlVPS2012HddQuota" runat="server">
        ...
        <td class="Normal"><fcp:Quota ID="quotavps2012hddquota" runat="server" QuotaName="VPS2012.Hdd" DisplayGauge="True" /></td>
    </tr>
</table>
</div>
