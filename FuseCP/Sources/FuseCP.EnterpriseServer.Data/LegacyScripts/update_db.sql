...
BEGIN
	...
	INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (371, 167, N'Proxmox', N'Proxmox Virtualization', N'FuseCP.Providers.Virtualization.ProxmoxvpsLocal, FuseCP.Providers.Virtualization.Proxmoxvps', N'Proxmox', 0)
	END
	ELSE
	BEGIN
	UPDATE [dbo].[Providers] SET [ProviderName] = 'Proxmox (remote)', [DisplayName] = 'Proxmox Virtualization (remote)' WHERE [ProviderName] = 'Proxmox'
...
BEGIN
INSERT [Providers] ([ProviderID], [GroupId], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES(305, 90, N'MySQL', N'MySQL Server 8.1', N'FuseCP.Providers.Database.MySqlServer81, FuseCP.Providers.Database.MySQL', N'MySQL', NULL)
END

IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [DisplayName] = 'MySQL Server 8.2')
BEGIN
INSERT [Providers] ([ProviderID], [GroupId], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES(306, 90, N'MySQL', N'MySQL Server 8.2', N'FuseCP.Providers.Database.MySqlServer82, FuseCP.Providers.Database.MySQL', N'MySQL', NULL)
END

IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [DisplayName] = 'MySQL Server 8.3')
BEGIN
INSERT [Providers] ([ProviderID], [GroupId], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES(307, 90, N'MySQL', N'MySQL Server 8.3', N'FuseCP.Providers.Database.MySqlServer83, FuseCP.Providers.Database.MySQL', N'MySQL', NULL)
END

IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [DisplayName] = 'MySQL Server 8.4')
BEGIN
INSERT [Providers] ([ProviderID], [GroupId], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES(308, 90, N'MySQL', N'MySQL Server 8.4', N'FuseCP.Providers.Database.MySqlServer84, FuseCP.Providers.Database.MySQL', N'MySQL', NULL)
END
...
BEGIN
INSERT [dbo].[ResourceGroups] ([GroupID], [GroupName], [GroupOrder], [GroupController], [ShowGroup]) VALUES (91, N'MySQL9', 12, N'FuseCP.EnterpriseServer.DatabaseServerController', 1)
END
GO

IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [DisplayName] = 'MySQL Server 9.0')
BEGIN
INSERT [Providers] ([ProviderID], [GroupId], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES(320, 90, N'MySQL', N'MySQL Server 9.0', N'FuseCP.Providers.Database.MySqlServer90, FuseCP.Providers.Database.MySQL', N'MySQL', NULL)
END
GO
...
BEGIN
INSERT [dbo].[ServiceItemTypes] ([ItemTypeID], [GroupID], [DisplayName], [TypeName], [TypeOrder], [CalculateDiskspace], [CalculateBandwidth], [Suspendable], [Disposable], [Searchable], [Importable], [Backupable]) VALUES (90, 91, N'MySQL9Database', N'FuseCP.Providers.Database.SqlDatabase, FuseCP.Providers.Base', 20, 1, 0, 0, 1, 1, 1, 1)
INSERT [dbo].[ServiceItemTypes] ([ItemTypeID], [GroupID], [DisplayName], [TypeName], [TypeOrder], [CalculateDiskspace], [CalculateBandwidth], [Suspendable], [Disposable], [Searchable], [Importable], [Backupable]) VALUES (91, 91, N'MySQL9User', N'FuseCP.Providers.Database.SqlUser, FuseCP.Providers.Base', 21, 0, 0, 0, 1, 1, 1, 1)
END
GO
...
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1571, 50, N'MariaDB', N'MariaDB 10.4', N'FuseCP.Providers.Database.MariaDB104, FuseCP.Providers.Database.MariaDB', N'MariaDB', NULL)
END
GO
IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [ProviderID] = '1572')
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1572, 50, N'MariaDB', N'MariaDB 10.5', N'FuseCP.Providers.Database.MariaDB105, FuseCP.Providers.Database.MariaDB', N'MariaDB', NULL)
END
IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [ProviderID] = '1573')
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1573, 50, N'MariaDB', N'MariaDB 10.6', N'FuseCP.Providers.Database.MariaDB106, FuseCP.Providers.Database.MariaDB', N'MariaDB', NULL)
END
IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [ProviderID] = '1574')
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1574, 50, N'MariaDB', N'MariaDB 10.7', N'FuseCP.Providers.Database.MariaDB107, FuseCP.Providers.Database.MariaDB', N'MariaDB', NULL)
END
IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [ProviderID] = '1575')
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1575, 50, N'MariaDB', N'MariaDB 10.8', N'FuseCP.Providers.Database.MariaDB108, FuseCP.Providers.Database.MariaDB', N'MariaDB', NULL)
END
IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [ProviderID] = '1576')
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1576, 50, N'MariaDB', N'MariaDB 10.9', N'FuseCP.Providers.Database.MariaDB109, FuseCP.Providers.Database.MariaDB', N'MariaDB', NULL)
END
IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [ProviderID] = '1577')
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1577, 50, N'MariaDB', N'MariaDB 10.10', N'FuseCP.Providers.Database.MariaDB1010, FuseCP.Providers.Database.MariaDB', N'MariaDB', NULL)
END
IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [ProviderID] = '1578')
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1578, 50, N'MariaDB', N'MariaDB 10.11', N'FuseCP.Providers.Database.MariaDB1011, FuseCP.Providers.Database.MariaDB', N'MariaDB', NULL)
END
IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [ProviderID] = '1579')
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1579, 50, N'MariaDB', N'MariaDB 11.0', N'FuseCP.Providers.Database.MariaDB110, FuseCP.Providers.Database.MariaDB', N'MariaDB', NULL)
END
IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [ProviderID] = '1580')
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1580, 50, N'MariaDB', N'MariaDB 11.1', N'FuseCP.Providers.Database.MariaDB111, FuseCP.Providers.Database.MariaDB', N'MariaDB', NULL)
END
IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [ProviderID] = '1581')
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1581, 50, N'MariaDB', N'MariaDB 11.2', N'FuseCP.Providers.Database.MariaDB112, FuseCP.Providers.Database.MariaDB', N'MariaDB', NULL)
END
IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [ProviderID] = '1582')
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1582, 50, N'MariaDB', N'MariaDB 11.3', N'FuseCP.Providers.Database.MariaDB113, FuseCP.Providers.Database.MariaDB', N'MariaDB', NULL)
END
IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [ProviderID] = '1583')
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1583, 50, N'MariaDB', N'MariaDB 11.4', N'FuseCP.Providers.Database.MariaDB114, FuseCP.Providers.Database.MariaDB', N'MariaDB', NULL)
END
IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [ProviderID] = '1584')
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1584, 50, N'MariaDB', N'MariaDB 11.5', N'FuseCP.Providers.Database.MariaDB115, FuseCP.Providers.Database.MariaDB', N'MariaDB', NULL)
END
IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [ProviderID] = '1585')
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1585, 50, N'MariaDB', N'MariaDB 11.6', N'FuseCP.Providers.Database.MariaDB116, FuseCP.Providers.Database.MariaDB', N'MariaDB', NULL)
END
IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [ProviderID] = '1586')
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1586, 50, N'MariaDB', N'MariaDB 11.7', N'FuseCP.Providers.Database.MariaDB117, FuseCP.Providers.Database.MariaDB', N'MariaDB', NULL)
END
...
BEGIN
INSERT [dbo].[ScheduleTasks] ([TaskID], [TaskType], [RoleID]) VALUES (N'SCHEDULE_TASK_CHECK_WEBSITES_SSL', N'FuseCP.EnterpriseServer.CheckWebsitesSslTask, FuseCP.EnterpriseServer.Code', 3)
END
GO
...
BEGIN
INSERT [dbo].[ScheduleTaskViewConfiguration] ([TaskID], [ConfigurationID], [Environment], [Description]) VALUES (N'SCHEDULE_TASK_CHECK_WEBSITES_SSL', N'ASP_NET', N'ASP.NET', N'~/DesktopModules/FuseCP/ScheduleTaskControls/CheckWebsitesSslView.ascx')
END
GO
...
BEGIN
INSERT [dbo].[Providers] ([ProviderId], [GroupId], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES(500, 1, N'UnixSystem', N'Unix System', N'FuseCP.Providers.OS.Unix, FuseCP.Providers.OS.Unix', N'Unix',	NULL)
END
GO
...
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1910, 3, N'vsftpd', N'vsftpd FTP Server 3', N'FuseCP.Providers.FTP.VsFtp3, FuseCP.Providers.FTP.VsFtp', N'vsftpd', NULL)
END
GO
...
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1911, 2, N'Apache', N'Apache Web Server 2.4', N'FuseCP.Providers.Web.Apache24, FuseCP.Providers.Web.Apache', N'Apache', NULL)
END
GO
...
UPDATE [Providers] SET [ProviderType] = 'FuseCP.Providers.RemoteDesktopServices.Windows2022,FuseCP.Providers.RemoteDesktopServices.Windows2022' WHERE [ProviderID] = '1504'
UPDATE [Providers] SET [ProviderType] = 'FuseCP.Providers.RemoteDesktopServices.Windows2025,FuseCP.Providers.RemoteDesktopServices.Windows2025' WHERE [ProviderID] = '1505'
GO
...
BEGIN
INSERT [dbo].[ResourceGroups] ([GroupID], [GroupName], [GroupOrder], [GroupController], [ShowGroup]) VALUES (76, N'MsSQL2025', 10, N'FuseCP.EnterpriseServer.DatabaseServerController', 1)
END
GO

IF NOT EXISTS (SELECT * FROM [dbo].[Providers] WHERE [DisplayName] = 'Microsoft SQL Server 2025')
BEGIN
INSERT [dbo].[Providers] ([ProviderID], [GroupID], [ProviderName], [DisplayName], [ProviderType], [EditorControl], [DisableAutoDiscovery]) VALUES (1707, 76, N'MsSQL', N'Microsoft SQL Server 2025', N'FuseCP.Providers.Database.MsSqlServer2025, FuseCP.Providers.Database.SqlServer', N'MSSQL', NULL)
INSERT [dbo].[ServiceItemTypes] ([ItemTypeID], [GroupID], [DisplayName], [TypeName], [TypeOrder], [CalculateDiskspace], [CalculateBandwidth], [Suspendable], [Disposable], [Searchable], [Importable], [Backupable]) VALUES (205, 76, N'MsSQL2022Database', N'FuseCP.Providers.Database.SqlDatabase, FuseCP.Providers.Base', 1, 1, 0, 0, 1, 1, 1, 1)
INSERT [dbo].[ServiceItemTypes] ([ItemTypeID], [GroupID], [DisplayName], [TypeName], [TypeOrder], [CalculateDiskspace], [CalculateBandwidth], [Suspendable], [Disposable], [Searchable], [Importable], [Backupable]) VALUES (206, 75, N'MsSQL2022User', N'FuseCP.Providers.Database.SqlUser, FuseCP.Providers.Base', 1, 0, 0, 0, 1, 1, 1, 1)
