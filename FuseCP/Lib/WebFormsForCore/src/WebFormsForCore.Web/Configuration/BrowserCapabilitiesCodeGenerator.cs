...
//#endif
        ...
        private void GenerateAssembly() {
            ...
            CSharpCodeProvider cfcp = new CSharpCodeProvider();
            ...
            try {
                cfcp.GenerateCodeFromCompileUnit(ccu, twriter, null);
            }
            finally {
                if(twriter != null)
                    twriter.Close();
            ...
            try {
                results = cfcp.CompileAssemblyFromFile(compilerParameters, _browsersDirectory + "\\BrowserCapsFactory.cs");
            }
            finally {
